...
export async function readVoiceExpense(blob:Blob,context:{categories:Array<{name:string;subcategories:string[]}>;accounts:Array<{name:string;institution:string;operator:string}>}):Promise<VoiceTransaction>{
